...
- Notes indexed: 16
- Status summary: new (2), closed (10), fixed (3), not-a-bug (1)

| Id | Title | Status | Severity | Reported | Fixed | Linear |
| --- | --- | --- | --- | --- | --- | --- |
| BUG-0015 | [Desktop dev startup is blocked by TypeScript errors in main-process test files](../03_Bugs/BUG-0015_desktop-dev-startup-is-blocked-by-typescript-errors-in-main-process-test-files.md) | new | sev-3 | 2026-04-13 | - | - |
| BUG-0013 | [Heading whitespace visual issue - requires verification](../03_Bugs/BUG-0013_heading-whitespace-visual-issue-requires-verification.md) | new | sev-3 | 2026-04-12 | - | - |
...
| BUG-0014 | [Arrow key navigation stack overflow - requires verification](../03_Bugs/BUG-0014_arrow-key-navigation-stack-overflow-requires-verification.md) | not-a-bug | sev-3 | 2026-04-12 | 2026-04-13 | - |
