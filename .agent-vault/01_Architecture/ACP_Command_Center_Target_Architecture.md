...
- Historical (aggregator-era, fully superseded): [[01_Architecture/Connector_Package_Runtime|Connector Package Runtime]], [[06_Shared_Knowledge/sync-architecture|Sync Architecture]], [[06_Shared_Knowledge/fred-workflow-design|Fred Premium Workflow Design]], [[06_Shared_Knowledge/conflict-resolution-design|Conflict Resolution Design]] — re-pointed 2026-07-12 (STEP-21-05).
