...
- Jira API tokens will be stored only in OS keychain / secure local storage behind the Electron main-process boundary.
...
- 2026-04-21 - Accepted during Phase 21 planning. Jira settings remain user-configurable in the UI, while the API token is stored in OS keychain storage behind Electron main.
