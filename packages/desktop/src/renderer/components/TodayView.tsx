  ...
  return (
    <div className="space-y-8">
      ...
      {FIXTURE_BLOCKERS.length > 0 && (
        <section id="section-blockers" className="animate-slide-up stagger-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Priorities (Jira) */}
        <section id="section-priorities" className="animate-slide-up stagger-2">
          <h2 className="section-heading mb-3 flex items-center gap-2">
        ...
        {/* Schedule (Outlook) */}
        <section id="section-schedule" className="animate-slide-up stagger-3">
          <h2 className="section-heading mb-3 flex items-center gap-2">
            <svg className="w-3.5 h-3.5 text-srgnt-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
      ...
      <section id="section-attention-needed" className="animate-slide-up stagger-4">
        <h2 className="section-heading mb-3 flex items-center gap-2">
          <svg className="w-3.5 h-3.5 text-srgnt-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
